...
# Hard brackets = crash at startup if missing — app cannot run without a DB
DB_URL = os.environ["DATABASE_URL"]
AWS_REGION = os.environ.get("AWS_REGION", "us-east-1")
TRADE_EVENTS_TOPIC_ARN = os.environ.get("TRADE_EVENTS_TOPIC_ARN", "")
# LocalStack endpoint for local dev — not set in production
...
def submit_trade():
    ...
    # Generate trade_id if client didn't provide one
